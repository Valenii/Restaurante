<?php
session_start(); // Esto es necesario para poder usar $_SESSION
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <main class="servicios">
      ...
      <div class="container">
        <div class="service">
          ...
          <p>Ordená tu comida favorita desde nuestra web con un proceso simple y rápido.</p>
        </div>
        <div class="service">
          <h2>Delivery Rápido</h2>
          <p>Recibí tu pedido en minutos gracias a nuestro servicio de reparto eficiente.</p>
        </div>
        <div class="service">
          <h2>Catering para Eventos</h2>
          <p>Organizá tu fiesta con nuestro catering personalizado para grupos grandes.</p>
        </div>
        <div class="service">
          <h2>App Móvil Próximamente</h2>
          <p>Próximamente tendrás nuestra app para pedir desde tu celular fácilmente.</p>
        </div>
        <div class="service">
          <h2>Medios de Pago</h2>
          <p>Aceptamos tarjetas, transferencias y pagos digitales para tu comodidad.</p>
        </div>
        <div class="service">
          <h2>Programa de Puntos</h2>
          <p>Acumulá puntos con cada compra y canjealos por productos y descuentos.</p>
        </div>
      </div>
    </main>
  </div>
